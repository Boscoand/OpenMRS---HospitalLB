...
import AmbulatorioInicio from './container/Seguro';
import AmbulatorioP from './container/Responsable';
  ...
  return (
    <Route path="/" component={App}>
        <Route path="ambulatorio">
              <Route path="inicio" component={AmbulatorioInicio}/>
              <Route path="datos" component={AmbulatorioP}/>
        </Route>
    </Route>
  );
}
