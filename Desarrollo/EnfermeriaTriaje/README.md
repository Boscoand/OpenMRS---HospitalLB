...
This repository contains the EnfermeriaTriaje OpenMRS Open Web App.
...
This will create a file called `enfermeriatriaje.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/usr/local/tomcat/.OpenMRS/owa`
...
{
  "LOCAL_OWA_FOLDER": "/usr/local/tomcat/.OpenMRS/owa",
  "APP_ENTRY_POINT": "http://localhost:9001/openmrs/owa/enfermeriatriaje/index.html"
}
```
