 ...
 */
// generated on 2018-01-13 using generator-openmrs-owa 0.6.0
'use strict';
...
const THIS_APP_ID = 'enfermeriatriaje';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/enfermeriatriaje/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/enfermeriatriaje`,
	  css: `${__dirname}/app/css/enfermeriatriaje.css`,
	  vendor : [
