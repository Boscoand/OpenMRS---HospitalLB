 ...
 */
// generated on 2018-02-04 using generator-openmrs-owa 0.6.0
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/admisiones`,
	  css: `${__dirname}/app/css/admisiones.css`,
	  vendor : [
