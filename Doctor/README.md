...
This repository contains the Doctor OpenMRS Open Web App.
...
This will create a file called `doctor.zip` file in the `dist` directory,
...
{
  "LOCAL_OWA_FOLDER": "/usr/local/tomcat/.OpenMRS/owa",
  "APP_ENTRY_POINT": "http://localhost:9001/openmrs/owa/doctor/index.html"
}
```
