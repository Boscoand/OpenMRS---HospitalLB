 ...
 */
// generated on 2018-02-13 using generator-openmrs-owa 0.6.0
'use strict';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/doctor/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/doctor`,
	  css: `${__dirname}/app/css/doctor.css`,
	  vendor : [
